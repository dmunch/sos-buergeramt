defmodule Scraper do
  ...
  def load_for_date_and_anliegen(date, anliegen, cache_control) do
    ...
    url = String.replace(url, "{anliegen}", Integer.to_string(anliegen))
  ...
  def run do
    ...
    |> Enum.flat_map(fn date -> [
      #Task.async(&load_for_date_and_anliegen(&1, @anliegen_personalausweis, cache_control)),
      # Task.async(&load_for_date_and_anliegen(&1, @anliegen_wohnung, cache_control)),
      # Task.async(&load_for_date_and_anliegen(&1, @anliegen_reisepass, cache_control)),
        load_for_date_and_anliegen_async(date, @anliegen_personalausweis, cache_control),
        load_for_date_and_anliegen_async(date, @anliegen_wohnung, cache_control),
        load_for_date_and_anliegen_async(date, @anliegen_reisepass, cache_control)
    ] end)
